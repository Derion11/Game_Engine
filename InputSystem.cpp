...
{
	// Implementasi untuk memproses input, seperti membaca status tombol keyboard dan posisi mouse, kemudian memanggil metode yang sesuai pada listener yang terdaftar
	...
	{
		// Jika posisi mouse berubah, kita perlu menghitung delta pergerakan mouse dan memanggil onMouseMove pada semua listener yang terdaftar
