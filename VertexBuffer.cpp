...
bool VertexBuffer::load(void* list_vertices, UINT size_vertex, UINT size_list, void*shader_byte_code, UINT size_byte_shader)
{
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		{ "COLOR", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 } // menambahkan elemen input untuk warna dengan format DXGI_FORMAT_R32G32B32_FLOAT, yang menunjukkan bahwa setiap vertex akan memiliki atribut warna yang terdiri dari tiga komponen float (merah, hijau, biru) yang dimulai pada byte offset 12 dalam struktur data vertex, memungkinkan shader untuk mengakses informasi warna untuk setiap vertex selama rendering
	};
